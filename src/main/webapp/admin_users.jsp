...
<script>
    ...
    function fetchUsers() {
        const url = "https://springbootjfsdsdps17-5-production.up.railway.app/admin/readusers"; // Adjust API URL as needed
        ...
        currentPageData.forEach(function(user) {
            ...
            row.innerHTML = `
                ...
                <td>
                    ...
                    <button class="btn" onclick='del("`+user.email+`")'>Delete</button>
                </td>`;
